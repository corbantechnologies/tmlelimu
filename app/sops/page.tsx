    ...
    <div className="min-h-screen bg-zinc-50 pb-20">
      ...
      <div className="bg-[#004d40] text-white pt-24 pb-16 px-6 md:px-12 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-full h-full opacity-10 pointer-events-none">
          <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[150%] bg-amber-500 rounded-full blur-[100px]" />
          <div className="absolute bottom-[-20%] left-[-10%] w-[40%] h-[100%] bg-emerald-400 rounded-full blur-[120px]" />
        </div>
        
        <div className="max-w-6xl mx-auto relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-2xl">
            <div className="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium bg-white/10 text-emerald-100 border border-white/20 mb-6 backdrop-blur-sm">
          ...
          <div className="w-full md:w-80 space-y-2">
            <div className="relative">
              ...
              <Input
                ...
                className="w-full pl-10 h-12 bg-white text-zinc-900 border-none rounded-2xl shadow-lg placeholder:text-zinc-500 focus-visible:ring-2 focus-visible:ring-amber-500"
              />
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredSops.map((sop: Sops) => (
              <div 
                key={sop.id} 
                className="bg-white rounded-3xl p-6 shadow-md shadow-zinc-200/50 border border-zinc-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col"
              >
                <div className="flex-grow">
                  <div className="w-12 h-12 bg-amber-50 rounded-2xl flex items-center justify-center text-amber-600 mb-5 relative group-hover:scale-110 transition-transform">
                ...
                <div className="mt-auto">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="flex w-full items-center justify-center gap-2 bg-zinc-50 hover:bg-[#004d40] text-zinc-700 hover:text-white border border-zinc-200 hover:border-[#004d40] rounded-xl py-3 font-semibold transition-colors"
                  >
          ...
          <div className="bg-white rounded-3xl p-16 text-center shadow-sm border border-zinc-100 mt-8">
            <div className="w-20 h-20 bg-zinc-50 rounded-full flex items-center justify-center text-zinc-400 mx-auto mb-6">
