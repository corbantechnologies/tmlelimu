            ...
            {isSuccess ? (
              <div className="flex flex-col items-center justify-center space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <Button 
                    ...
                    className="w-full h-14 bg-[#004d40] hover:bg-[#00332b] text-white rounded-xl text-lg font-bold shadow-lg shadow-[#004d40]/20 transition-all hover:scale-[1.01] active:scale-95"
                >
                    Enter Reset Code
                </Button>
              </div>
