      ...
      <main className="flex-grow">
        ...
        <section className="relative px-6 py-20 md:px-12 lg:py-32 overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full -z-10 opacity-5">
             <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#004d40] rounded-full blur-[120px]"></div>
             <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-amber-600 rounded-full blur-[120px]"></div>
          </div>

          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium bg-amber-50 text-amber-700 border border-amber-100 mb-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <Link href="/login" className="w-full sm:w-auto px-8 py-4 text-lg font-bold text-white bg-[#004d40] rounded-2xl hover:bg-[#00332b] transition-all shadow-xl hover:-translate-y-1">
                  Start Learning Now
                </Link>
                <Link href="#features" className="w-full sm:w-auto px-8 py-4 text-lg font-semibold text-[#004d40] border-2 border-[#004d40]/10 rounded-2xl hover:bg-zinc-50 transition-all">
                  Explore Courses
                </Link>
              </div>
            </div>
            ...
            <div className="flex-1 relative">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-6 -right-6 w-24 h-24 bg-amber-100 rounded-full -z-10 animate-pulse"></div>
              <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-emerald-50 rounded-full -z-10 animate-bounce transition-all duration-1000"></div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-12 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-zinc-100 hover:shadow-md transition-shadow">
                <div className="w-14 h-14 bg-emerald-100 rounded-2xl flex items-center justify-center text-[#004d40] mb-6 mx-auto">
              ...
              {/* Feature 2 */}
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-zinc-100 hover:shadow-md transition-shadow">
                <div className="w-14 h-14 bg-amber-100 rounded-2xl flex items-center justify-center text-amber-700 mb-6 mx-auto">
                    <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Feature 3 */}
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-zinc-100 hover:shadow-md transition-shadow">
                <div className="w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center text-blue-700 mb-6 mx-auto">
                    <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
